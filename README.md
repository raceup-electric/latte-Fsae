...
* **Intensity/Reflectivity Visualization:** Replaced the default height-based colormap with the measured Intensity or Reflectivity data present in the .bin data 
